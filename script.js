...
function initExperience() {
    ...
    loadingManager.onError = (url) => {
        ...
        loadingScreen.innerHTML = '<p style="color: #ec4899;">Error loading model. Check console.</p>';
    };

    // Smooth Scroll with Lenis (global variable)
    ...
    // Try to load - adjust path as needed
    loader.load(
        './models/thixotropic-gel.glb', // Make sure this path is correct!
        (gltf) => {
            model = gltf.scene;
        ...
        (error) => {
            ...
            loadingScreen.innerHTML = `
                <p style="color: #ec4899;">Error loading model</p>
                <p style="font-size: 0.8rem; margin-top: 1rem;">Check that models/thixotropic-gel.glb exists</p>
            `;
        }
    );
